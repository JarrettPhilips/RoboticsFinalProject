...
def findLargestContour(contours):
	...
	numberOfContoursLargerThanTenPixels = 0;
	...
	for x in contours :
		...
		if area > largestContourArea :
			...
			largestContour = x
		if area > 10 :
			numberOfContoursLargerThanTenPixels = numberOfContoursLargerThanTenPixels + 1

	print "Largest Contour:", largestContour
	print "Largest Area:", largestContourArea
	print "There are", len(contours), "total contours"
	print "There are", numberOfContoursLargerThanTenPixels, "contours larger than 10 pixels"
...
def updateAltitude():
	...
	if areaOfLandingSquareInPixels == 0.0 :
		print "Landing pad area found"
		#doesPadExist()
...
def doesPadExist(imageName):
	...
	if areAreasSimilar(contourAreasSorted[1], contourAreasSorted[2]) :
		...
		areaOfLandingSquareInPixels = contourAreasSorted[1]
		return 1
	else :
		print "No pad found"
		return -1
